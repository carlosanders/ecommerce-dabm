...
O propósito deste trabalho é apresentar um propósito de Loja Virtual para a DAbM distribuir seus Uniformes pela Internet, gerando a GRU em nome do militar.




alternativa do Laravel dividido em módulos próximo ao formato do **Domain Driven Design (DDD)**, baseado nos conceitos praticados pelos amigos do [Codecasts][codecasts], que desde já agradeço por compartilhar conosco as experiencias em desenvolvimento com Laravel, meus parabéns a equipe.
