...
elixir(function (mix) {
  ...
  mix.copy(bowerDir + 'bootstrap/fonts', 'public/common/fonts')
    ...
    //easyUI
    .copy(bowerDir + 'kimifdw-jquery-easyui/jquery.easyui.min.js', 'public/vendor/easyui/jquery.easyui.min.js')
    .copy(bowerDir + 'kimifdw-jquery-easyui/themes', 'public/vendor/easyui/themes')
    .copy(bowerDir + 'kimifdw-jquery-easyui/locale', 'public/vendor/easyui/locale')
    .copy(bowerDir + 'kimifdw-jquery-easyui/plugins', 'public/vendor/easyui/plugins');
